...
for drop in "${dropouts[@]}"; do
    _folder="/Users/jchevall/JWST/Simulations/XDF/${drop}_DROPOUTS/ineb_Jan16_logU_xid_delayed_SFR-Gaussian_max_age-Gaussian_weights_mass_SFR_logU/${MC_run}/ETC-simulations"
